...
(function(todo, data, $) {
    ...
    todo.init = function (options) {
        ...
        $.each(codes, function (index, value) {
            ...
            var placeholder, runOnce = false, currentArea, taskItems, taskItemsAbove, taskPoints = 0, budget = 74, allTaskPoints = 0;
            var sortIndex;
            var secondSortIndex;
            var position = 0;
            var positionTwo = 0;
                    ...
                    if(ui.sender == null){
                        ...
                        if (placeholder.parent().attr('id') == "pending" && currentArea == "inProgress" && allTaskPoints > budget && position >= positionTwo) {
                            ...
                            $.each(taskItemsAbove, function (index, value) {
                                ...
                                taskItemsAbove += $(value).data("points");

                            });

                            console.log(allTaskPoints + " större än budget " + budget);
                            console.log(taskItemsAbove);
