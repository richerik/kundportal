...
(function(todo, data, $) {
    ...
    todo.init = function (options) {
        ...
        $.each(codes, function (index, value) {
            ...
            var placeholder, runOnce = false, currentArea, taskItems, taskPoints = 0, budget = 74, allTaskPoints = 0;
            ...
            $(value).sortable({
                ...
                change: function(event, ui) {
                    ...
                    if (placeholder.parent().attr('id') == "pending" && currentArea == "inProgress" && allTaskPoints > budget) {
                        ...
                        console.log(allTaskPoints + " större än budget " + budget);
                        ...
                        if (ui.item.data("points") > taskPoints) {
                            ...
                            placeholder.remove();
                            newPlaceholder.insertAfter("#inProgress h3");
                ...
                stop: function (event, ui) {
                    ...
                    if ($(".remove") && ui.item.parent().attr('id') == "pending") {
                        $(".remove").insertAfter("#inProgress h3");
                        ui.item.removeClass("green");
                    }
                    if (ui.item.parent().attr('id') == "inProgress" && taskItems) {
